...
// ─── Pre-loaded templates from TimeTune ─────────────────────────────────────
// Based on Miguel's actual schedules: LMV (Mon/Wed/Fri) and MJ (Tue/Thu)
...
export const DEFAULT_TEMPLATES: DayTemplate[] = [
  {
    ...
    activities: [
      ...
      { id: 'lmv-3', name: 'Ejercicio', description: 'Rutina A/B Santi Grazino', category: 'training', startTime: '07:20', duration: 40 },
      ...
      { id: 'lmv-11', name: 'Ida', description: 'Camino hacia la FES, leer algo', category: 'commute', startTime: '14:30', duration: 90 },
      { id: 'lmv-12', name: 'Universidad', description: 'Atención, contactos, networking, interacción social', category: 'work', startTime: '16:00', duration: 300 },
  ...
  },
  {
    ...
    activities: [
      ...
      { id: 'mj-10', name: 'Ida', description: 'Camino hacia la FES, leer algo, checar pendientes', category: 'commute', startTime: '13:30', duration: 90 },
      { id: 'mj-11', name: 'Universidad', description: 'Atención, contactos, networking, interacción social', category: 'work', startTime: '15:00', duration: 360 },
...
export const DEFAULT_HABITS = [
  { id: 'h-1', name: 'Código Python',   icon: '🐍', color: '#4ade80', targetDays: ['mon','tue','wed','thu','fri'], createdAt: new Date().toISOString() },
  { id: 'h-2', name: 'LeetCode',        icon: '⚡', color: '#fbbf24', targetDays: ['mon','tue','wed','thu','fri'], createdAt: new Date().toISOString() },
  { id: 'h-3', name: 'Inglés 30 min',   icon: '🌐', color: '#60a5fa', targetDays: ['mon','tue','wed','thu','fri','sat','sun'], createdAt: new Date().toISOString() },
  { id: 'h-4', name: 'Commit a GitHub', icon: '💾', color: '#a78bfa', targetDays: ['mon','tue','wed','thu','fri'], createdAt: new Date().toISOString() },
  { id: 'h-5', name: 'Leer docs',       icon: '📖', color: '#f97316', targetDays: ['mon','tue','wed','thu','fri'], createdAt: new Date().toISOString() },
  { id: 'h-6', name: 'Ejercicio',       icon: '🏋️', color: '#ff6a8e', targetDays: ['mon','wed','fri'], createdAt: new Date().toISOString() },
  { id: 'h-7', name: 'Journaling',      icon: '✍️', color: '#fb7185', targetDays: ['mon','tue','wed','thu','fri','sat','sun'], createdAt: new Date().toISOString() },
];
